...
public class ReduxStateLists {
	...
	public static final DeferredHolder<ExtendableStateList, ExtendableStateList> BLEAKMOSS =
		STATE_LISTS.register("bleakmoss", () ->
			new ExtendableStateList(
				250,
				150,
	...
	public static final DeferredHolder<ExtendableStateList, ExtendableStateList> GILDENMOSS =
		STATE_LISTS.register("gildenmoss", () ->
			new ExtendableStateList(
				250,
				150,
				SimpleWeightedRandomList.<BlockState>builder()
