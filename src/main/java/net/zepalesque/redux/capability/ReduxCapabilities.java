...
public class ReduxCapabilities {
    ...
    public static class Registration {
        ...
        public static <T extends Sentry> void attachEntityCapabilities(AttachCapabilitiesEvent<Entity> event) {
            ...
            if (event.getObject() instanceof Moa moa && moa.getLevel().isClientSide()) {
            ...
            if (event.getObject() instanceof Sentry sentry && sentry.getLevel().isClientSide()) {
            ...
            if (event.getObject() instanceof Mimic mimic && mimic.getLevel().isClientSide()) {
