...
public class ReduxConfig {
    ...
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            this.blight_temp_min = builder.comment("Minimum Temperature value for the Blight.").worldRestart().translation("config.aether_redux.biomes.blight.temp_min").define("Min", ReduxRegion.Params.blight_temp_min);
            this.blight_temp_max = builder.comment("Maximum Temperature value for the Blight.").worldRestart().translation("config.aether_redux.biomes.blight.temp_max").define("Max", ReduxRegion.Params.blight_temp_max);
            builder.pop();
            builder.push("Humidity");
            this.blight_humid_min = builder.comment("Minimum Humidity value for the Blight.").worldRestart().translation("config.aether_redux.biomes.blight.humid_min").define("Min", ReduxRegion.Params.blight_humid_min);
            this.blight_humid_max = builder.comment("Maximum Humidity value for the Blight.").worldRestart().translation("config.aether_redux.biomes.blight.humid_max").define("Max", ReduxRegion.Params.blight_humid_max);
            builder.pop();
            builder.push("Depth");
            this.blight_depth_min = builder.comment("Minimum Depth value for the Blight.").worldRestart().translation("config.aether_redux.biomes.blight.depth_min").define("Min", ReduxRegion.Params.blight_depth_min);
            this.blight_depth_max = builder.comment("Maximum Depth value for the Blight.").worldRestart().translation("config.aether_redux.biomes.blight.depth_max").define("Max", ReduxRegion.Params.blight_depth_max);
            builder.pop(2);
            ...
            builder.push("Temperature");
            this.grove_temp_min = builder.comment("Minimum Temperature value for the Gilded Groves.").worldRestart().translation("config.aether_redux.biomes.grove.temp_min").define("Min", ReduxRegion.Params.grove_temp_min);
            this.grove_temp_max = builder.comment("Maximum Temperature value for the Gilded Groves.").worldRestart().translation("config.aether_redux.biomes.grove.temp_max").define("Max", ReduxRegion.Params.grove_temp_max);
            builder.pop();
            builder.push("Humidity");
            this.grove_humid_min = builder.comment("Minimum Humidity value for the Gilded Groves.").worldRestart().translation("config.aether_redux.biomes.grove.humid_min").define("Min", ReduxRegion.Params.grove_humid_min);
            this.grove_humid_max = builder.comment("Maximum Humidity value for the Gilded Groves.").worldRestart().translation("config.aether_redux.biomes.grove.humid_max").define("Max", ReduxRegion.Params.grove_humid_max);
            builder.pop(2);
            ...
            builder.push("Temperature");
            this.frost_temp_min = builder.comment("Minimum Temperature value for the Frosted Forests.").worldRestart().translation("config.aether_redux.biomes.frost.temp_min").define("Min", ReduxRegion.Params.frost_temp_min);
            this.frost_temp_max = builder.comment("Maximum Temperature value for the Frosted Forests.").worldRestart().translation("config.aether_redux.biomes.frost.temp_max").define("Max", ReduxRegion.Params.frost_temp_max);
            builder.pop();
            builder.push("Humidity");
            this.frost_humid_min = builder.comment("Minimum Humidity value for the Frosted Forests.").worldRestart().translation("config.aether_redux.biomes.frost.humid_min").define("Min", ReduxRegion.Params.frost_humid_min);
            this.frost_humid_max = builder.comment("Maximum Humidity value for the Frosted Forests.").worldRestart().translation("config.aether_redux.biomes.frost.humid_max").define("Max", ReduxRegion.Params.frost_humid_max);
            builder.pop(2);
            ...
            builder.push("Temperature");
            this.high_temp_min = builder.comment("Minimum Temperature value for the Highfields.").worldRestart().translation("config.aether_redux.biomes.high.temp_min").define("Min", ReduxRegion.Params.highfields_temp_min);
            this.high_temp_max = builder.comment("Maximum Temperature value for the Highfields.").worldRestart().translation("config.aether_redux.biomes.high.temp_max").define("Max", ReduxRegion.Params.highfields_temp_max);
            builder.pop();
            builder.push("Humidity");
            this.high_humid_min = builder.comment("Minimum Humidity value for the Highfields.").worldRestart().translation("config.aether_redux.biomes.high.humid_min").define("Min", ReduxRegion.Params.highfields_humid_min);
            this.high_humid_max = builder.comment("Maximum Humidity value for the Highfields.").worldRestart().translation("config.aether_redux.biomes.high.humid_max").define("Max", ReduxRegion.Params.highfields_humid_max);
            builder.pop(2);
            ...
            builder.push("Temperature");
            this.cap_temp_min = builder.comment("Minimum Temperature value for the Cloudcap Jungle.").worldRestart().translation("config.aether_redux.biomes.cap.temp_min").define("Min", ReduxRegion.Params.cloudcap_temp_min);
            this.cap_temp_max = builder.comment("Maximum Temperature value for the Cloudcap Jungle.").worldRestart().translation("config.aether_redux.biomes.cap.temp_max").define("Max", ReduxRegion.Params.cloudcap_temp_max);
            builder.pop();
            builder.push("Humidity");
            this.cap_humid_min = builder.comment("Minimum Humidity value for the Cloudcap Jungle.").worldRestart().translation("config.aether_redux.biomes.cap.humid_min").define("Min", ReduxRegion.Params.cloudcap_humid_min);
            this.cap_humid_max = builder.comment("Maximum Humidity value for the Cloudcap Jungle.").worldRestart().translation("config.aether_redux.biomes.cap.humid_max").define("Max", ReduxRegion.Params.cloudcap_humid_max);
            builder.pop();
            builder.push("Depth");
            this.cap_depth_min = builder.comment("Minimum Depth value for the Cloudcap Jungle.").worldRestart().translation("config.aether_redux.biomes.cap.depth_min").define("Min", ReduxRegion.Params.cloudcap_depth_min);
            this.cap_depth_max = builder.comment("Maximum Depth value for the Cloudcap Jungle.").worldRestart().translation("config.aether_redux.biomes.cap.depth_max").define("Max", ReduxRegion.Params.cloudcap_depth_max);
            builder.pop(4);
            builder.push("Fun");
