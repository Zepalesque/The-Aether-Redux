...
public class LegacyBlightwillowFoliagePlacer extends FoliagePlacer {
    public static final Codec<LegacyBlightwillowFoliagePlacer> CODEC = RecordCodecBuilder.create((p2) -> {
        return foliagePlacerParts(p2).apply(p2, LegacyBlightwillowFoliagePlacer::new);
    });

    public LegacyBlightwillowFoliagePlacer(IntProvider rad, IntProvider offs) {
        super(rad, offs);
    }

    protected FoliagePlacerType<?> type() {
        return ReduxFoliagePlacers.LEGACY_BLIGHTWILLOW.get();
    }
