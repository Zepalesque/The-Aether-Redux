...
public class ReduxTrunkPlacers {
    ...
    public static final RegistryObject<TrunkPlacerType<BlightwillowTrunkPlacer>> BLIGHTWILLOW_TRUNK = TRUNK_PLACERS.register("blightwillow_trunk", () -> new TrunkPlacerType<>(BlightwillowTrunkPlacer.CODEC));
