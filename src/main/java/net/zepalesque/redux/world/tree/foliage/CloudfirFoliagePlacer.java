...
public class CloudfirFoliagePlacer extends FoliagePlacer {
	public static final MapCodec<CloudfirFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(
		builder -> foliagePlacerParts(builder)
			...
			.apply(builder, CloudfirFoliagePlacer::new)
	);
