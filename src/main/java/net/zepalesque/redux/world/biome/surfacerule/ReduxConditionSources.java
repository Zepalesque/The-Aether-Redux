...
public class ReduxConditionSources {
    public static final DeferredRegister<Codec<? extends SurfaceRules.ConditionSource>> CONDITIONS = DeferredRegister.create(Registry.CONDITION_REGISTRY, Redux.MODID);
