...
import net.zepalesque.redux.world.biome.surfacerule.FlagRule;
...
//                SurfaceRules.ifTrue(SurfaceRules.isBiome(ReduxBiomes.FROSTED_TUNDRA), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.state((ReduxBlocks.FROSTED_AETHER_GRASS_BLOCK.get()).defaultBlockState().setValue(AetherBlockStateProperties.DOUBLE_DROPS, true)))),
                ...
                SurfaceRules.ifTrue(SurfaceRules.isBiome(ReduxBiomes.GILDED_GROVES), SurfaceRules.ifTrue(new FlagRule(Flags.ENCHGRASS), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.state((AetherBlocks.ENCHANTED_AETHER_GRASS_BLOCK.get().defaultBlockState()))))),
                SurfaceRules.ifTrue(SurfaceRules.isBiome(ReduxBiomes.GILDED_GRASSLANDS), SurfaceRules.ifTrue(new FlagRule(Flags.ENCHGRASS), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.state((AetherBlocks.ENCHANTED_AETHER_GRASS_BLOCK.get().defaultBlockState()))))),
