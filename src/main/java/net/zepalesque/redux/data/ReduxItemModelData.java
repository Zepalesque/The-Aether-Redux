...
public class ReduxItemModelData extends AetherItemModelProvider {
    ...
    protected void registerModels() {
        ...
        itemBlock(ReduxBlocks.PINK_CANDYFLOSS_BLOCK);
        itemBlock(ReduxBlocks.BLUE_CANDYFLOSS_BLOCK);
        ...
        eggItem(ReduxItems.PHUDGE_SPAWN_EGG);
        ...
        item(ReduxItems.LOBOTIUM_ICON.get(), "misc/");
        ...
        this.itemBlockFlat(ReduxBlocks.SUGARSPROUTS.get(), "natural/");
        ...
        this.item(ReduxItems.SKYBUD_PETAL, "food/");
