...
public class ReduxAdvancementData extends ForgeAdvancementProvider {
    ...
    public static class ReduxAdvancements implements AdvancementGenerator, IConditionBuilder  {
        ...
        @Override
        public void generate(HolderLookup.Provider provider, Consumer<Advancement> output, ExistingFileHelper existingFileHelper) {
            
            Advancement.Builder.advancement()
                .parent(new ResourceLocation(Aether.MODID, "the_aether"))
                .display(
                    AetherItems.GOLDEN_RING.get(),
                    Component.translatable("advancement.aether_redux.throw_ring_in_lava"),
                    Component.translatable("advancement.aether_redux.throw_ring_in_lava.desc")
                ...
                .addCriterion("throw_ring_in_lava",
                    ReduxAdvancementTriggers.throwRing())
                .save(output, Redux.locate("throw_ring_in_lava"), existingFileHelper);
            ...
            Advancement.Builder.advancement()
                ...
                .save(output, Redux.locate("double_jump"), existingFileHelper);
            ...
            Advancement.Builder.advancement()
                ...
                .save(output, Redux.locate("obtain_grand_medal"), existingFileHelper);
            Advancement.Builder.advancement()
                ...
                .save(output, Redux.locate("kill_sheepuff_with_fireball"), existingFileHelper);
            ...
            Advancement veridium = Advancement.Builder.advancement()
                ...
                .save(output, Redux.locate("infuse_veridium"), existingFileHelper);
            ...
            Advancement.Builder.advancement()
                ...
                .save(output, Redux.locate("obtain_feather_of_warding"), existingFileHelper);
        }
    }
