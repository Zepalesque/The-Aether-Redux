...
public class ReduxBlockStateData extends ReduxBlockStateProvider {
	...
	protected void registerStatesAndModels() {
		...
		this.leaves(ReduxBlocks.PRISMA_LEAVES.get(), "natural/");
		this.leafPile(ReduxBlocks.PRISMA_LEAF_PILE.get(), ReduxBlocks.PRISMA_LEAVES.get(), "natural/");
		...
		this.crossTintedOverlay(ReduxBlocks.VERBENA_CLUSTER.get(), "natural/");
