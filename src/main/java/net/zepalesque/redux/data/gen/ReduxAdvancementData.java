...
public class ReduxAdvancementData extends AdvancementProvider {
	...
	public ReduxAdvancementData(
		...
		super(
			...
			registries,
			existingFileHelper,
			List.of(new ReduxAdvancements(Redux.MODID, suffixColor))
		);
	...
	public static class ReduxAdvancements implements AdvancementGenerator, IConditionBuilder {
		...
		public void generate(
			...
			AdvancementHolder aether = Advancement.Builder.advancement().build(
			...
			Advancement.Builder.advancement()
				...
				.display(
					...
					Component.translatable("advancement." + this.modid + ".throw_ring_in_lava.desc").append(
						Component.translatable("gui." + this.modid + ".advancement_suffix").withStyle((style) ->
							style.withColor(this.suffixColor)
						)
					),
					null,
							...
							EntityPredicate.wrap(
								Optional.of(
									EntityPredicate.Builder.entity()
										.located(LocationPredicate.Builder.inDimension(Level.NETHER))
										.build()
								)
							)
						)
