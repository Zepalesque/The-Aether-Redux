    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> builder) {
        builder.accept(ReduxLoot.LOBOTIUM_DUNGEON, LootTable.lootTable(
                ...
                // Random Stuff
                        ...
                        .add(LootItem.lootTableItem(AetherItems.SKYROOT_STICK.get()).setWeight(5))
                        .add(LootItem.lootTableItem(ReduxBlocks.SPLITFERN.get()).setWeight(3))
                        .add(LootItem.lootTableItem(ReduxItems.WYNDSPROUT_SEEDS.get()).setWeight(11))
                        .add(LootItem.lootTableItem(ReduxItems.LEMON_POPROCKS.get()).setWeight(8))
                        .add(LootItem.lootTableItem(ReduxItems.OATMEAL.get()).setWeight(7))
                        .add(LootItem.lootTableItem(ReduxItems.BLUEBERRY_BAGEL.get()).setWeight(9))
                        .add(LootItem.lootTableItem(AetherItems.CANDY_CANE.get()).setWeight(6))
                        .add(LootItem.lootTableItem(ReduxBlocks.RAINBOW_AERCLOUD.get()).setWeight(2))
                // Cobwebs
