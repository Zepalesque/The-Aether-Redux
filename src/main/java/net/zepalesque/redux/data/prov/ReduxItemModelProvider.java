...
public abstract class ReduxItemModelProvider extends AetherItemModelProvider {
    ...
    public void itemOverlayDungeonBlock(Block block, Block baseBlock, String overlay, String suffix) {
        this.withExistingParent(this.blockName(block), this.mcLoc("block/cube"))
                .texture("overlay", new ResourceLocation(Aether.MODID, "block/dungeon/" + overlay)).texture("face", this.texture(this.blockName(baseBlock) + suffix, "dungeon/"))
