    ...
    public static void bootstrap(BootstapContext<Biome> context) {
        ...
        context.register(THE_BLIGHT, biomeBase(
                ores(baseFeatures(new BiomeGenerationSettings.Builder(placedFeatures, configuredCarvers), false, false, true, true, false))
                        ...
                        .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.BLIGHTED_GRASS_PATCH)
                        ...
                        .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.THORNCAP_PATCH)
        ...
        context.register(FROSTED_FORESTS, biomeBase(
                ores(baseFeatures(new BiomeGenerationSettings.Builder(placedFeatures, configuredCarvers), false, false, true, true, false))
                        ...
                        .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.FROSTED_GRASS_PATCH)
        ...
        context.register(GILDED_GROVES, biomeBase(
                ores(baseFeatures(new BiomeGenerationSettings.Builder(placedFeatures, configuredCarvers), false, false, true, true, false))
                        ...
                        .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.ENCHANTED_GRASS_PATCH)
        ...
        context.register(HIGHFIELDS, biomeBase(
                ores(baseFeatures(new BiomeGenerationSettings.Builder(placedFeatures, configuredCarvers), false, false, true, true, false))
                        ...
                        .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.FIRECAP_PATCH)
                ,
