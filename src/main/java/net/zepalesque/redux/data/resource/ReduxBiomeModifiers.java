    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        BiomeModifier water = new WaterModifier(
            ...
            RegistryMap.Builder.<Biome, Integer>create() // water
                ...
                .put(ReduxBiomes.CLOUDCAPS, 0x9DBDEA)
            ...
            RegistryMap.Builder.<Biome, Integer>create() // fog
                ...
                .put(ReduxBiomes.CLOUDCAPS, 0x1B2128)
        ...
        BiomeModifier sky = new SkiesModifier(
            ...
            RegistryMap.Builder.<Biome, Integer>create() // sky
                .put(ReduxBiomes.THE_BLIGHT, 0x7C7DA5)
                ...
                .build(biomes),
            RegistryMap.Builder.<Biome, Integer>create() // fog
                .put(ReduxBiomes.THE_BLIGHT, 0xADAED3)
        ...
        context.register(VANILLA_GRASS_OVERRIDE, new FoliageModifier(
