...
public class ReduxFeaturePlacements extends ReduxPlacementBuilders {
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(
			context,
			SENTRITE_ORE,
			configs.getOrThrow(ReduxFeatureConfig.SENTRITE_ORE),
		...
		register(
			context,
			ANGILITE_ORE,
			configs.getOrThrow(ReduxFeatureConfig.ANGILITE_ORE),
			InSquarePlacement.spread(),
		...
		register(
			context,
			LARGE_ICESTONE_ORE,
			configs.getOrThrow(ReduxFeatureConfig.LARGE_ICESTONE_ORE),
		...
		PlacementUtils.register(
			context,
			MOSSY_HOLYSTONE_ORE,
			configs.getOrThrow(ReduxFeatureConfig.MOSSY_HOLYSTONE_ORE),
		...
		PlacementUtils.register(
			...
			configs.getOrThrow(ReduxFeatureConfig.GILDED_HOLYSTONE_ORE),
			CountPlacement.of(24),
			InSquarePlacement.spread(),
			HeightRangePlacement.of(UniformHeight.of(VerticalAnchor.BOTTOM, VerticalAnchor.absolute(128))),
			ConditionPlacementModule.of(conditions.getOrThrow(ReduxConditions.MOSSY_ORE)),
		...
		PlacementUtils.register(
			...
			configs.getOrThrow(ReduxFeatureConfig.BLEAKMOSS_HOLYSTONE_ORE),
			CountPlacement.of(24),
			InSquarePlacement.spread(),
			HeightRangePlacement.of(UniformHeight.of(VerticalAnchor.BOTTOM, VerticalAnchor.absolute(128))),
			ConditionPlacementModule.of(conditions.getOrThrow(ReduxConditions.MOSSY_ORE)),
		...
		PlacementUtils.register(
			context,
			GROVE_TREES,
			configs.getOrThrow(ReduxFeatureConfig.GROVE_TREES),
			CountPlacement.of(
				new WeightedListInt(
		...
		PlacementUtils.register(
			context,
			SKYFIELDS_TREES,
			configs.getOrThrow(ReduxFeatureConfig.SKYFIELDS_TREES),
			CountPlacement.of(
				new WeightedListInt(
					SimpleWeightedRandomList.<IntProvider>builder()
			...
			ImprovedLayerPlacementModifier.of(Heightmap.Types.OCEAN_FLOOR, ConstantInt.of(2), 4),
			BiomeFilter.biome(),
			PlacementUtils.filteredByBlockSurvival(ReduxFlowerSets.PRISMA_SAPLING.flower().get()),
			blacklist
		);
		PlacementUtils.register(
			context,
			BLIGHT_TREES,
			configs.getOrThrow(ReduxFeatureConfig.BLIGHT_TREES),
			CountPlacement.of(
				new WeightedListInt(
					SimpleWeightedRandomList.<IntProvider>builder()
		...
		PlacementUtils.register(
			context,
			AURUM_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.AURUM_PATCH),
			threshold,
		...
		PlacementUtils.register(
			context,
			LUCKY_CLOVER_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.LUCKY_CLOVER_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 2), 4),
			RarityFilter.onAverageOnceEvery(16),
			BiomeFilter.biome()
		...
		PlacementUtils.register(
			...
			configs.getOrThrow(ReduxFeatureConfig.GOLDEN_CLOVERS_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
			BiomeFilter.biome()
		);
		...
		PlacementUtils.register(
			context,
			TURBO_VERBENA_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.TURBO_VERBENA_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
			BiomeFilter.biome()
		);
		...
		PlacementUtils.register(
			context,
			CAELGAE_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.CAELGAE_PATCH),
			threshold,
		...
		PlacementUtils.register(
			context,
			BLOOMTAIL,
			configs.getOrThrow(ReduxFeatureConfig.BLOOMTAIL),
			threshold,
		...
		PlacementUtils.register(
			context,
			SPARSE_AMBROSIUM_ORE,
			configs.getOrThrow(AetherConfiguredFeatures.ORE_AMBROSIUM_CONFIGURATION),
		...
		PlacementUtils.register(
			context,
			SPARSE_ZANITE_ORE,
			configs.getOrThrow(AetherConfiguredFeatures.ORE_ZANITE_CONFIGURATION),
			NitrogenPlacedFeatureBuilders.commonOrePlacement(
				7,
		...
		PlacementUtils.register(
			context,
			AMBROSIUM_ROCK,
			configs.getOrThrow(ReduxFeatureConfig.AMBROSIUM_ROCK),
			threshold,
		...
		register(
			context,
			ICESTONE_ROCK,
			configs.getOrThrow(ReduxFeatureConfig.ICESTONE_ROCK),
			threshold,
			ImprovedLayerPlacementModifier.of(
				Heightmap.Types.MOTION_BLOCKING,
				new WeightedListInt(
		...
		register(
			context,
			AEROGEL_DISK,
			configs.getOrThrow(ReduxFeatureConfig.AEROGEL_DISK),
		...
		register(
			context,
			HOLYSILT_DISK,
			configs.getOrThrow(ReduxFeatureConfig.HOLYSILT_DISK),
			RarityFilter.onAverageOnceEvery(5),
			PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
			BiomeFilter.biome(),
			blacklist
		...
		register(
			...
			CountPlacement.of(
				new WeightedListInt(
					SimpleWeightedRandomList.<IntProvider>builder().add(ConstantInt.of(24), 9).add(ConstantInt.of(16), 1).build()
				)
			),
			ImprovedLayerPlacementModifier.of(Heightmap.Types.OCEAN_FLOOR, UniformInt.of(0, 1), 4),
			BiomeFilter.biome(),
		...
		register(
			...
			CountPlacement.of(
				new WeightedListInt(
					SimpleWeightedRandomList.<IntProvider>builder().add(ConstantInt.of(8), 9).add(ConstantInt.of(6), 1).build()
				)
			),
			ImprovedLayerPlacementModifier.of(Heightmap.Types.OCEAN_FLOOR, UniformInt.of(0, 1), 4),
			BiomeFilter.biome(),
		...
		register(
			context,
			LUMINA_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.LUMINA_PATCH),
			threshold,
		...
		register(
			context,
			DAGGERBLOOM_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.DAGGERBLOOM_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 2), 4),
		...
		register(
			context,
			SPARSE_PURPLE_FLOWER_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.SPARSE_PURPLE_FLOWER_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 2), 4),
		...
		register(
			context,
			SKYFERN_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.SKYFERN_PATCH),
			threshold,
		...
		register(
			context,
			LUNAERA_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.LUNAERA_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 3), 4),
			RarityFilter.onAverageOnceEvery(5),
			BiomeFilter.biome()
		...
		register(
			context,
			AVELIUM_ROOTS_PATCH,
			configs.getOrThrow(ReduxFeatureConfig.AVELIUM_ROOTS_PATCH),
			threshold,
			ImprovedLayerPlacementModifier.of(Heightmap.Types.MOTION_BLOCKING, UniformInt.of(0, 3), 4),
			RarityFilter.onAverageOnceEvery(5),
			BiomeFilter.biome()
