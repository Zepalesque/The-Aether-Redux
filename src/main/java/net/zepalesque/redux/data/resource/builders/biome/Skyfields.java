			...
			.mobSpawnSettings(
				new MobSpawnSettings.Builder()
					...
					.addSpawn(
						...
						new MobSpawnSettings.SpawnerData(AetherEntityTypes.PHYG.get(), 8, 3, 4)
					)
					.addSpawn(
						MobCategory.CREATURE,
						new MobSpawnSettings.SpawnerData(AetherEntityTypes.SHEEPUFF.get(), 14, 3, 4)
					)
					.addSpawn(
						MobCategory.CREATURE,
						new MobSpawnSettings.SpawnerData(AetherEntityTypes.FLYING_COW.get(), 8, 2, 5)
					)
					.addSpawn(
						MobCategory.CREATURE,
						new MobSpawnSettings.SpawnerData(AetherEntityTypes.AERBUNNY.get(), 18, 3, 3)
					)
					.addSpawn(
						MobCategory.CREATURE,
						new MobSpawnSettings.SpawnerData(AetherEntityTypes.MOA.get(), 10, 1, 3)
					)
					.build()
			)
			.generationSettings(
