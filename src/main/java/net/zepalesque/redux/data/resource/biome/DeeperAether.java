    ...
    public static Biome generate(BootstapContext<Biome> context) {
        ...
        new BiomeSpecialEffects.Builder()
                ...
                new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ReduxEntityTypes.QUAIL_TM.get(), 15, 2, 5))
        ...
        new BiomeGenerationSettings.Builder(placed, carvers)
                ...
                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.DEEP_TREES)
                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AetherPlacedFeatures.HOLIDAY_TREE_PLACEMENT)
                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.DEEP_GRASS_PATCH)
                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.FLAWLESS_BLOOM_PATCH)
                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.ROOTROSE_PATCH)
                ...
                .addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, ReduxPlacedFeatures.RAINBOW_AERCLOUD)
