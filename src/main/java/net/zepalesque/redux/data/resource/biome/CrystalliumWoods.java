...
public class CrystalliumWoods {
    ...
    public static Biome generate(BootstapContext<Biome> context) {
        ...
        new BiomeGenerationSettings.Builder(placed, carvers)
                ...
                .addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, ReduxPlacedFeatures.CRYSTAL_GOLD_ORE)

                .addFeature(GenerationStep.Decoration.FLUID_SPRINGS, AetherPlacedFeatures.WATER_SPRING_PLACEMENT)

                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.CRYSTALLIUM_TREES)
                ...
                .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ReduxPlacedFeatures.EDELWEISS_PATCH)
