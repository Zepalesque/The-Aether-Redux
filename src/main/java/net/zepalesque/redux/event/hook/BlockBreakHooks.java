...
public class BlockBreakHooks {
    ...
    private static final Map<Block, Block> BREAK_SPEED_REMAP = Maps.newHashMap((new ImmutableMap.Builder<Block, Block>())
            ...
            .put(AetherBlocks.ENCHANTED_AETHER_GRASS_BLOCK.get(), Blocks.GRASS_BLOCK)
            .put(ReduxBlocks.BLIGHTED_AETHER_GRASS_BLOCK.get(), Blocks.GRASS_BLOCK)
            .put(ReduxBlocks.FROSTED_AETHER_GRASS_BLOCK.get(), Blocks.GRASS_BLOCK)
