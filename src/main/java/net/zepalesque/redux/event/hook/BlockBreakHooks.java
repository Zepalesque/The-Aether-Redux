...
public class BlockBreakHooks {
    ...
    private static final Lazy<Map<Block, Float>> BREAK_SPEED_REMAP = Lazy.of(() -> Maps.newHashMap((new ImmutableMap.Builder<Block, Float>()
            ...
            .put(ReduxBlocks.ROCK_CANDY.get(), 0.5F)
            .put(ReduxBlocks.ROCK_CANDY_WALL.get(), 0.5F)
            .put(ReduxBlocks.ROCK_CANDY_STAIRS.get(), 0.5F)
            .put(ReduxBlocks.ROCK_CANDY_SLAB.get(), 0.65F)
