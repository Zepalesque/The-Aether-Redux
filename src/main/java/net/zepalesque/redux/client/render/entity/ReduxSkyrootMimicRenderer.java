...
public class ReduxSkyrootMimicRenderer extends MobRenderer<Mimic, EntityModel<Mimic>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("aether_genesis", "textures/entity/mobs/mimic/normal.png");
    ...
    public ReduxSkyrootMimicRenderer(EntityRendererProvider.Context renderer) {
    ...
    public ResourceLocation getTextureLocation(@Nonnull Mimic mimic) {
        ResourceLocation baseTexture = ModList.get().isLoaded("lootr") ? LOOTR_TEXTURE : this.isChristmas ? XMAS_TEXTURE : TEXTURE;
        ...
        return shouldUseReduxModel() ? reduxTexture : baseTexture;
    }
