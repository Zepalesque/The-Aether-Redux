...
public class CockatriceReduxModel extends EntityModel<Cockatrice> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition feathers_top_r1 = head_feather_top.addOrReplaceChild("feathers_top_r1", CubeListBuilder.create().texOffs(52, 0).addBox(-6.0F, -10.0F, 0.0F, 12.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));
        ...
        PartDefinition feather_r1 = top_feather_1.addOrReplaceChild("feather_r1", CubeListBuilder.create().texOffs(84, 2).addBox(-4.0F, -8.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 5.0F, 0.0F, -1.5272F, 0.0F, 0.0F));
        ...
        PartDefinition feather_r2 = top_feather_2.addOrReplaceChild("feather_r2", CubeListBuilder.create().texOffs(90, 2).addBox(0.0F, -8.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, 0.0F, -1.5272F, 0.0F, 0.0F));
        ...
        PartDefinition feathers_r1 = head_feather_left.addOrReplaceChild("feathers_r1", CubeListBuilder.create().texOffs(108, 104).addBox(0.0F, -5.0F, -2.0F, 0.0F, 8.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.0F, 0.2618F, 0.0F));
        ...
        PartDefinition feathers_r2 = head_feather_right.addOrReplaceChild("feathers_r2", CubeListBuilder.create().texOffs(108, 104).mirror().addBox(0.0F, -5.0F, -2.0F, 0.0F, 8.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.0F, -0.2618F, 0.0F));
        ...
        PartDefinition feather_r3 = crown_feather.addOrReplaceChild("feather_r3", CubeListBuilder.create().texOffs(70, 17).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));

        PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create(), PartPose.offset(0.0F, -8.0F, -2.0F));

        PartDefinition jaw_natural_rotation = jaw.addOrReplaceChild("jaw_natural_rotation", CubeListBuilder.create().texOffs(80, 14).addBox(-3.0F, 8.0F, -10.0F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition feather_r4 = middle_feather.addOrReplaceChild("feather_r4", CubeListBuilder.create().texOffs(86, 58).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.9599F, 0.0F, 0.0F));
        ...
        PartDefinition feather_r5 = right_feather.addOrReplaceChild("feather_r5", CubeListBuilder.create().texOffs(94, 86).addBox(-5.0F, 0.0F, 0.0F, 6.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.5236F, -0.5236F, 0.0F));
        ...
        PartDefinition feather_r6 = left_feather.addOrReplaceChild("feather_r6", CubeListBuilder.create().texOffs(106, 86).addBox(-1.0F, 0.0F, 0.0F, 6.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.5236F, 0.5236F, 0.0F));
        ...
        PartDefinition z_rot_wing_1 = wing_1.addOrReplaceChild("z_rot_wing_1", CubeListBuilder.create().texOffs(54, 40).addBox(-3.0F, 0.0F, -4.0F, 2.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -2.0F, 2.0F));

        PartDefinition feathers_1_wing1 = z_rot_wing_1.addOrReplaceChild("feathers_1_wing1", CubeListBuilder.create().texOffs(22, 42).addBox(-1.5F, -2.0F, -1.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 4.0F, -1.0F));
        ...
        PartDefinition wing_feathers_r1 = feathers_2_wing1.addOrReplaceChild("wing_feathers_r1", CubeListBuilder.create().texOffs(22, 42).addBox(-1.5F, -3.0F, -2.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, -0.3054F, 0.0F, 0.0F));
        ...
        PartDefinition wing_feathers_r2 = feathers_3_wing1.addOrReplaceChild("wing_feathers_r2", CubeListBuilder.create().texOffs(22, 40).addBox(-1.5F, -2.0F, -13.0F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.0F, 9.0F, -0.6981F, 0.0F, 0.0F));

        PartDefinition claw1 = z_rot_wing_1.addOrReplaceChild("claw1", CubeListBuilder.create(), PartPose.offset(2.0F, 14.0F, -1.5F));

        PartDefinition claw_r1 = claw1.addOrReplaceChild("claw_r1", CubeListBuilder.create().texOffs(30, 32).addBox(-2.5F, 0.0F, -3.0F, 5.0F, 4.0F, 3.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-5.0F, 0.0F, 0.0F, 0.0F, 1.5708F, -1.5708F));
        ...
        PartDefinition z_rot_wing_2 = wing_2.addOrReplaceChild("z_rot_wing_2", CubeListBuilder.create().texOffs(54, 40).mirror().addBox(1.0F, 0.0F, -4.0F, 2.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, -2.0F, 2.0F));

        PartDefinition feathers_1_wing2 = z_rot_wing_2.addOrReplaceChild("feathers_1_wing2", CubeListBuilder.create().texOffs(22, 42).mirror().addBox(1.5F, -2.0F, -1.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 4.0F, -1.0F));
        ...
        PartDefinition wing_feathers_r3 = feathers_2_wing2.addOrReplaceChild("wing_feathers_r3", CubeListBuilder.create().texOffs(22, 42).mirror().addBox(1.5F, -3.0F, -2.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, -0.3054F, 0.0F, 0.0F));
        ...
        PartDefinition wing_feathers_r4 = feathers_3_wing2.addOrReplaceChild("wing_feathers_r4", CubeListBuilder.create().texOffs(22, 40).mirror().addBox(1.5F, -2.0F, -13.0F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 7.0F, 9.0F, -0.6981F, 0.0F, 0.0F));

        PartDefinition claw2 = z_rot_wing_2.addOrReplaceChild("claw2", CubeListBuilder.create(), PartPose.offset(-2.0F, 14.0F, -1.5F));

        PartDefinition claw_r2 = claw2.addOrReplaceChild("claw_r2", CubeListBuilder.create().texOffs(30, 32).mirror().addBox(-2.5F, 0.0F, -3.0F, 5.0F, 4.0F, 3.0F, new CubeDeformation(-0.01F)).mirror(false), PartPose.offsetAndRotation(5.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 1.5708F));

        PartDefinition ribcage = body.addOrReplaceChild("ribcage", CubeListBuilder.create().texOffs(51, 25).addBox(-6.0F, -1.5F, -4.51F, 12.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.5F, -6.5F));
        ...
        PartDefinition feathers_leg1 = base_leg1.addOrReplaceChild("feathers_leg1", CubeListBuilder.create().texOffs(0, 34).addBox(-3.0F, 0.0F, 0.05F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.5F, 7.7F));
        ...
        PartDefinition upper_leg1_r2 = nail.addOrReplaceChild("upper_leg1_r2", CubeListBuilder.create().texOffs(0, 26).addBox(0.0F, 8.0F, 2.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.4F, -7.75F, 0.5236F, 0.0F, 0.0F));
        ...
        PartDefinition toe3_leg1_r1 = toes_stepanim_leg1.addOrReplaceChild("toe3_leg1_r1", CubeListBuilder.create().texOffs(25, 7).addBox(-0.5F, -1.5F, -3.5F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 1.25F, -1.0F, -0.2618F, -0.3491F, -0.1745F));

        PartDefinition toe2_leg1_r1 = toes_stepanim_leg1.addOrReplaceChild("toe2_leg1_r1", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -3.0F, -1.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.75F, -5.0F, -0.3927F, 0.0F, 0.0F));

        PartDefinition toe1_leg1_r1 = toes_stepanim_leg1.addOrReplaceChild("toe1_leg1_r1", CubeListBuilder.create().texOffs(25, 7).mirror().addBox(-0.5F, -1.5F, -3.5F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, 1.25F, -1.0F, -0.2618F, 0.3491F, 0.1745F));
        ...
        PartDefinition back_toe_leg1_r1 = back_toes_leg1.addOrReplaceChild("back_toe_leg1_r1", CubeListBuilder.create().texOffs(2, 29).addBox(-1.0F, -0.5F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.75F, 4.0F, -0.4363F, 0.0F, 0.0F));
        ...
        PartDefinition upper_leg1_r3 = base_leg2.addOrReplaceChild("upper_leg1_r3", CubeListBuilder.create().texOffs(0, 12).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.5236F, 0.0F, 0.0F));
        ...
        PartDefinition feathers_leg2 = base_leg2.addOrReplaceChild("feathers_leg2", CubeListBuilder.create().texOffs(0, 34).mirror().addBox(-3.0F, 0.0F, 0.05F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 10.5F, 7.7F));
        ...
        PartDefinition upper_leg1_r4 = nail2.addOrReplaceChild("upper_leg1_r4", CubeListBuilder.create().texOffs(0, 26).mirror().addBox(0.0F, 8.0F, 2.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -9.4F, -7.75F, 0.5236F, 0.0F, 0.0F));

        PartDefinition lower_leg2 = base_leg2.addOrReplaceChild("lower_leg2", CubeListBuilder.create(), PartPose.offset(0.0F, 10.0F, 5.0F));

        PartDefinition lower_piece_leg1_r2 = lower_leg2.addOrReplaceChild("lower_piece_leg1_r2", CubeListBuilder.create().texOffs(16, 12).mirror().addBox(-1.5F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6109F, 0.0F, 0.0F));
        ...
        PartDefinition toe3_leg1_r2 = toes_stepanim_leg2.addOrReplaceChild("toe3_leg1_r2", CubeListBuilder.create().texOffs(25, 7).mirror().addBox(-0.5F, -1.5F, -3.5F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, 1.25F, -1.0F, -0.2618F, 0.3491F, 0.1745F));

        PartDefinition toe2_leg1_r2 = toes_stepanim_leg2.addOrReplaceChild("toe2_leg1_r2", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(-0.5F, -3.0F, -1.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.75F, -5.0F, -0.3927F, 0.0F, 0.0F));

        PartDefinition toe1_leg1_r2 = toes_stepanim_leg2.addOrReplaceChild("toe1_leg1_r2", CubeListBuilder.create().texOffs(25, 7).addBox(-0.5F, -1.5F, -3.5F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 1.25F, -1.0F, -0.2618F, -0.3491F, -0.1745F));
        ...
        PartDefinition back_toe_leg1_r2 = back_toes_leg2.addOrReplaceChild("back_toe_leg1_r2", CubeListBuilder.create().texOffs(2, 29).mirror().addBox(0.0F, -0.5F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.75F, 4.0F, -0.4363F, 0.0F, 0.0F));
