...
public class MoaReduxModel extends EntityModel<Moa> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition feathers_1_wing1 = z_rot_wing_1.addOrReplaceChild("feathers_1_wing1", CubeListBuilder.create().texOffs(60, 20).addBox(-1.5F, -2.0F, 0.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 3.0F, -2.0F));
        ...
        PartDefinition wing_feathers_r1 = feathers_2_wing1.addOrReplaceChild("wing_feathers_r1", CubeListBuilder.create().texOffs(60, 16).addBox(-1.25F, -2.0F, 0.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));
        ...
        PartDefinition wing_feathers_r2 = feathers_3_wing1.addOrReplaceChild("wing_feathers_r2", CubeListBuilder.create().texOffs(60, 14).addBox(-1.0F, -2.0F, 0.0F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.0F));
    ...
    public static LayerDefinition createTalonsLayer() {
        ...
        PartDefinition head_feather_top = feathers.addOrReplaceChild("head_feather_top", CubeListBuilder.create().texOffs(35, 3).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.0F, 4.0F));

        PartDefinition head_feather_left = feathers.addOrReplaceChild("head_feather_left", CubeListBuilder.create().texOffs(108, 106).addBox(0.0F, -5.0F, 0.0F, 0.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -2.0F, 4.0F));

        PartDefinition head_feather_right = feathers.addOrReplaceChild("head_feather_right", CubeListBuilder.create().texOffs(108, 106).mirror().addBox(0.0F, -5.0F, 0.0F, 0.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, -2.0F, 4.0F));
        ...
        PartDefinition tail1_r1 = middle_feather.addOrReplaceChild("tail1_r1", CubeListBuilder.create().texOffs(90, 62).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.4363F, 0.0F, 0.0F));

        PartDefinition right_feather = tail_feathers.addOrReplaceChild("right_feather", CubeListBuilder.create(), PartPose.offset(-4.0F, -26.0F, 10.0F));

        PartDefinition tail2_r1 = right_feather.addOrReplaceChild("tail2_r1", CubeListBuilder.create().texOffs(94, 86).addBox(-5.0F, 0.0F, 0.0F, 6.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 0.0F, 0.0F, 0.2618F, -0.5236F, 0.0F));

        PartDefinition left_feather = tail_feathers.addOrReplaceChild("left_feather", CubeListBuilder.create(), PartPose.offset(-4.0F, -26.0F, 10.0F));

        PartDefinition tail3_r1 = left_feather.addOrReplaceChild("tail3_r1", CubeListBuilder.create().texOffs(106, 86).addBox(-1.0F, 0.0F, 0.0F, 6.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, 0.0F, 0.0F, 0.2618F, 0.5236F, 0.0F));

        PartDefinition wing_1 = body_additions.addOrReplaceChild("wing_1", CubeListBuilder.create(), PartPose.offsetAndRotation(-8.2F, -4.0F, -4.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition z_rot_wing_1 = wing_1.addOrReplaceChild("z_rot_wing_1", CubeListBuilder.create().texOffs(54, 40).addBox(-3.0F, -1.0F, -4.0F, 2.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -1.0F, 2.0F));

        PartDefinition feathers_1_wing1 = z_rot_wing_1.addOrReplaceChild("feathers_1_wing1", CubeListBuilder.create().texOffs(22, 42).addBox(-1.5F, -2.0F, 0.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 3.0F, -2.0F));

        PartDefinition feathers_2_wing1 = z_rot_wing_1.addOrReplaceChild("feathers_2_wing1", CubeListBuilder.create(), PartPose.offset(-1.0F, 6.0F, -2.0F));

        PartDefinition wing_feathers_r1 = feathers_2_wing1.addOrReplaceChild("wing_feathers_r1", CubeListBuilder.create().texOffs(22, 42).addBox(-1.25F, -2.0F, 0.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

        PartDefinition feathers_3_wing1 = z_rot_wing_1.addOrReplaceChild("feathers_3_wing1", CubeListBuilder.create(), PartPose.offset(-1.0F, 9.0F, -2.0F));

        PartDefinition wing_feathers_r2 = feathers_3_wing1.addOrReplaceChild("wing_feathers_r2", CubeListBuilder.create().texOffs(22, 40).addBox(-1.0F, -2.0F, 0.0F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.0F));

        PartDefinition wing_2 = body_additions.addOrReplaceChild("wing_2", CubeListBuilder.create(), PartPose.offsetAndRotation(8.2F, -4.0F, -4.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition z_rot_wing_2 = wing_2.addOrReplaceChild("z_rot_wing_2", CubeListBuilder.create().texOffs(54, 40).mirror().addBox(1.0F, -1.0F, -4.0F, 2.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, -1.0F, 2.0F));

        PartDefinition feathers_1_wing2 = z_rot_wing_2.addOrReplaceChild("feathers_1_wing2", CubeListBuilder.create().texOffs(22, 42).mirror().addBox(1.5F, -2.0F, 0.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 3.0F, -2.0F));

        PartDefinition feathers_2_wing2 = z_rot_wing_2.addOrReplaceChild("feathers_2_wing2", CubeListBuilder.create(), PartPose.offset(1.0F, 6.0F, -2.0F));

        PartDefinition wing_feathers_r3 = feathers_2_wing2.addOrReplaceChild("wing_feathers_r3", CubeListBuilder.create().texOffs(22, 42).mirror().addBox(1.25F, -2.0F, 0.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

        PartDefinition feathers_3_wing2 = z_rot_wing_2.addOrReplaceChild("feathers_3_wing2", CubeListBuilder.create(), PartPose.offset(1.0F, 9.0F, -2.0F));

        PartDefinition wing_feathers_r4 = feathers_3_wing2.addOrReplaceChild("wing_feathers_r4", CubeListBuilder.create().texOffs(22, 40).mirror().addBox(1.0F, -2.0F, 0.0F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.0F));
        ...
        PartDefinition leg2 = base.addOrReplaceChild("leg2", CubeListBuilder.create(), PartPose.offset(-8.5F, 0.0F, 0.0F));
