...
public class MoaReduxModel extends EntityModel<Moa> {
    ...
    public static LayerDefinition createRefreshedLayer() {
        ...
        PartDefinition neck_piece = neck.addOrReplaceChild("neck_piece", CubeListBuilder.create().texOffs(88, 24).addBox(-2.0F, -10.0F, -4.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 2.0F));

        PartDefinition head_hurtanim = neck.addOrReplaceChild("head_hurtanim", CubeListBuilder.create(), PartPose.offset(0.0F, -10.0F, 0.0F));

        PartDefinition head_part = head_hurtanim.addOrReplaceChild("head_part", CubeListBuilder.create().texOffs(80, 0).addBox(-4.0F, -8.0F, -14.0F, 8.0F, 8.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition tail1_r1 = middle_feather.addOrReplaceChild("tail1_r1", CubeListBuilder.create().texOffs(102, 6).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.0F));

        PartDefinition right_feather = tail_feathers.addOrReplaceChild("right_feather", CubeListBuilder.create(), PartPose.offset(-4.0F, -26.0F, 10.0F));

        PartDefinition tail2_r1 = right_feather.addOrReplaceChild("tail2_r1", CubeListBuilder.create().texOffs(66, 54).addBox(-5.5F, 0.0F, 0.25F, 6.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 0.0F, 0.0F, -0.3491F, -0.2618F, 0.0F));

        PartDefinition left_feather = tail_feathers.addOrReplaceChild("left_feather", CubeListBuilder.create(), PartPose.offset(-4.0F, -26.0F, 10.0F));

        PartDefinition tail3_r1 = left_feather.addOrReplaceChild("tail3_r1", CubeListBuilder.create().texOffs(54, 54).addBox(-0.5F, 0.0F, 0.25F, 6.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, 0.0F, 0.0F, -0.3491F, 0.2618F, 0.0F));
