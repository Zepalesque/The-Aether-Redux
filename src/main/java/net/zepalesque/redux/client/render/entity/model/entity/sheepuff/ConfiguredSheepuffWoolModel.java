...
public class ConfiguredSheepuffWoolModel extends AbstractSheepuffWoolModel {

    public ConfiguredSheepuffWoolModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {MeshDefinition meshdefinition = new MeshDefinition();
        ...
        PartDefinition wool = main_body.addOrReplaceChild("wool", CubeListBuilder.create().texOffs(60, 61).addBox(-5.5F, -20.5F, -10.0F, 11.0F, 11.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.0F, -6.5F));

        PartDefinition sheepuff_wool = wool.addOrReplaceChild("sheepuff_wool", CubeListBuilder.create().texOffs(59, 14).addBox(-4.5F, -0.5F, -11.0F, 9.0F, 9.0F, 19.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -19.0F, 2.0F));

        PartDefinition kirrid_wool = wool.addOrReplaceChild("kirrid_wool", CubeListBuilder.create().texOffs(0, 47).addBox(-4.5F, -19.5F, -9.0F, 9.0F, 9.0F, 19.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg1 = main_body.addOrReplaceChild("leg1", CubeListBuilder.create(), PartPose.offset(-4.5F, 2.0F, -12.0F));

        PartDefinition wool_leg1 = leg1.addOrReplaceChild("wool_leg1", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -3.0F, -2.5F, 5.0F, 8.0F, 5.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leg2 = main_body.addOrReplaceChild("leg2", CubeListBuilder.create(), PartPose.offset(4.5F, 2.0F, -12.0F));

        PartDefinition wool_leg2 = leg2.addOrReplaceChild("wool_leg2", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -3.0F, -2.5F, 5.0F, 8.0F, 5.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 0.0F, 0.0F));
