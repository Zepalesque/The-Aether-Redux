...
public class CloudcapSporeParticle extends TextureSheetParticle {
	...
	public static class Falling implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			CloudcapSporeParticle dripparticle = new FallingSpore(level, x, y, z, Fluids.EMPTY, ReduxParticles.LANDING_CLOUDCAP_SPORE.get());
	...
	@OnlyIn(Dist.CLIENT)
	public static class FallingSpore extends FallingParticle {
