...
public class DynamicButton extends SlicedButton implements IDisplayPage {
    ...
    public DynamicButton(int x, int y, int width, int height, PackConfigMenu menu, Component message, Button.OnPress onPress, int page) {
        super(x, y, width, height, message, onPress);
        this.page = page;
        this.menu = menu;
    }
    
    public DynamicButton(int x, int y, int width, int height, PackConfigMenu menu, Component message, Button.OnPress onPress, int page, @Nullable Component hoverText) {
