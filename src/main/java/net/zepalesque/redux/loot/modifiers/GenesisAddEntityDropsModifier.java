...
public class GenesisAddEntityDropsModifier extends LootModifier {
    ...
    public static final Codec<GenesisAddEntityDropsModifier> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ItemStack.CODEC.fieldOf("item").forGetter(modifier -> modifier.itemStack),
            GenesisAddEntityDropsModifier.LOOT_FUNCTIONS_CODEC.fieldOf("functions").forGetter(modifier -> modifier.functions),
    ...
    public GenesisAddEntityDropsModifier(ItemStack itemStack, LootItemFunction[] functions, LootItemCondition[] conditions) {
        super(conditions);
