...
public class VeridiumAxeItem extends AxeItem implements VeridiumItem {
    public VeridiumAxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public Item getReplacementItem(ItemStack stack){
        return this.isCharged(stack) ? ReduxItems.VERIDIUM_AXE.get() : ReduxItems.INFUSED_VERIDIUM_AXE.get();
    }
