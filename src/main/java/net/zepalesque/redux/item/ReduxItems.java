...
public class ReduxItems {
    ...
    public static final RegistryObject<Item> RING_OF_WISDOM = register("ring_of_wisdom", () -> new AbilityTooltipRingItem(ReduxSoundEvents.EQUIP_WISDOM_RING, new Item.Properties().stacksTo(1).rarity(AetherItems.AETHER_LOOT), "wisdom_ring_xp_increase"));
