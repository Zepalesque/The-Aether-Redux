...
public class ReduxItems {
    ...
    public static final RegistryObject<Item> GOLDEN_SWET_BALL = register("golden_swet_ball", () -> new SwetBallItem(new Item.Properties().tab(AetherCreativeTabs.AETHER_FOOD_AND_DRINKS)));
...
//    public static final RegistryObject<Item> MOUSE_EAR_SOUP = register("mouse_ear_soup", () -> new BowlFoodItem(new Item.Properties().food(ReduxFoods.MOUSE_EAR_SOUP).stacksTo(1)));
    ...
    public static final RegistryObject<Item> ANCIENT_SENTRITE_MUSIC_DISC = ITEMS.register("ancient_sentrite_music_disc", () -> (new RecordItem(1, ReduxSoundEvents.MUSIC_DISC_SENTIENCE, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).tab(AetherCreativeTabs.AETHER_EQUIPMENT_AND_UTILITIES), 4300)));
    ...
    public static final RegistryObject<VeridiumSwordItem.Uninfused> VERIDIUM_SWORD = register("veridium_sword", () -> new VeridiumSwordItem.Uninfused(ReduxItemTiers.VERIDIUM, 2, -2.5F, new Item.Properties().tab(AetherCreativeTabs.AETHER_EQUIPMENT_AND_UTILITIES)));
    public static final RegistryObject<SwordItem> INFUSED_VERIDIUM_SWORD = register("infused_veridium_sword", () -> new VeridiumSwordItem(ReduxItemTiers.INFUSED_VERIDIUM, 4, -2.2F, new Item.Properties().tab(AetherCreativeTabs.AETHER_EQUIPMENT_AND_UTILITIES), ReduxItems.VERIDIUM_SWORD));
    ...
    public static final RegistryObject<VeridiumDartShooter.Uninfused> VERIDIUM_DART_SHOOTER = ITEMS.register("veridium_dart_shooter", () -> new VeridiumDartShooter.Uninfused(VERIDIUM_DART, 9, new Item.Properties().tab(AetherCreativeTabs.AETHER_EQUIPMENT_AND_UTILITIES).stacksTo(1)));
    public static final RegistryObject<VeridiumDartShooter> INFUSED_VERIDIUM_DART_SHOOTER = ITEMS.register("infused_veridium_dart_shooter", () -> new VeridiumDartShooter(VERIDIUM_DART, 7, new Item.Properties().tab(AetherCreativeTabs.AETHER_EQUIPMENT_AND_UTILITIES).stacksTo(1), ReduxItems.VERIDIUM_DART_SHOOTER));


    public static final RegistryObject<Item> COCKATRICE_FEATHER = register("cockatrice_feather", () -> new AbilityTooltipMiscItem(new Item.Properties().tab(AetherCreativeTabs.AETHER_ARMOR_AND_ACCESSORIES).stacksTo(1),
            "cockatrice_feather_protection"));

    public static final RegistryObject<Item> FEATHER_OF_WARDING = register("feather_of_warding", () -> new AbilityTooltipMiscItem(new Item.Properties().tab(AetherCreativeTabs.AETHER_ARMOR_AND_ACCESSORIES).stacksTo(1),
    ...
    public static final RegistryObject<Item> REFINED_SENTRITE = ITEMS.register("refined_sentrite", () -> new Item(new Item.Properties().tab(AetherCreativeTabs.AETHER_INGREDIENTS)));
    public static final RegistryObject<Item> SENTRITE_CHUNK = ITEMS.register("sentrite_chunk", () -> new Item(new Item.Properties().tab(AetherCreativeTabs.AETHER_INGREDIENTS)));
