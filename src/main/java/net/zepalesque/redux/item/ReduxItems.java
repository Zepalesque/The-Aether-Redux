...
import net.zepalesque.redux.item.food.SkyrootBowlFoodItem;
...
public class ReduxItems {
    ...
    public static final RegistryObject<Item> RING_OF_WISDOM = register("ring_of_wisdom", () -> new AbilityTooltipRingItem(ReduxSoundEvents.EQUIP_ENCHANTED_RING, new Item.Properties().stacksTo(1).rarity(AetherItems.AETHER_LOOT), "enchanted_ring_xp_increase"));
    ...
    public static final RegistryObject<SwordItem> INFUSED_VERIDIUM_SWORD = register("infused_veridium_sword", () -> new VeridiumSwordItem(ReduxItemTiers.INFUSED_VERIDIUM, 2, -2.2F, new Item.Properties()));
