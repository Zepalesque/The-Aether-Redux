...
public class ReduxFoods {
    ...
    public static final FoodProperties OATS = (new FoodProperties.Builder()).fast().nutrition(1).saturationMod(0F).build();
    ...
    public static final FoodProperties OAT_MUFFIN = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.2F).build();
