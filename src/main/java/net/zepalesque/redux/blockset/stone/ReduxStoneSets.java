...
public class ReduxStoneSets extends ReduxBlockSetBuilders {
	public static final BaseStoneSet GILDED_HOLYSTONE = register(
		new BaseStoneSet("gilded_holystone", MapColor.SAND, SoundType.STONE, 0.5F, 0.5F, "natural/")
	)
		.withLore(
	...
	public static final BaseStoneSet BLEAKMOSS_HOLYSTONE = register(
		...
		.withLore(
			"The blighted form of Mossy Holystone. The vicious moss on this rock wilts in the sunlight and flourishes in the moonlight."
		)
		.tabAfter(
			AetherCreativeTabs.AETHER_BUILDING_BLOCKS,
	...
	public static final BaseStoneSet SENTRITE = register(
		new BaseStoneSet("sentrite", MapColor.DEEPSLATE, SoundType.NETHER_ORE, 1.0F, 6.0F, "natural/")
	)
		.withLore(
			"A dark, metallic rock found throughout the Aether. This crude metal is used in a number of parts of Sentry technology, even their walls of Carved Stone are made of a mixture of this and Holystone."
		)
		.craftsInto(
	...
	public static final BaseStoneSet SENTRITE_BRICKS = register(
		new BrickStoneSet(
			"sentrite_brick",
			MapColor.DEEPSLATE,
			SoundType.NETHER_BRICKS,
	...
	public static final BaseStoneSet ANGILITE = register(
		new BaseStoneSet("angilite", MapColor.TERRACOTTA_YELLOW, SoundType.TUFF, 0.5F, 6.0F, "natural/")
	)
		// TODO: Idea: glowstone tiles via enchanting angelic stone? Maybe? Could be nice for ceiling lights in the silver dungeons
		.withLore(
			"A stone type found in the Aether. Angilite is commonly used in Valkyrian structures in its tile/brick form, Angelic Stone. Additionally, when enchanted, it buds into a dazzlingly bright glowing stone!"
		)
