...
public class ReduxStoneSets extends ReduxBlockSetBuilders {
    ...
    public static final BaseStoneSet BLEAKMOSS_HOLYSTONE = register(new BaseStoneSet("bleakmoss_holystone", MapColor.TERRACOTTA_PURPLE, SoundType.STONE, 0.5F, 0.5F, "natural/"))
            ...
            .tabAfter(AetherCreativeTabs.AETHER_BUILDING_BLOCKS, lazySetItem(ReduxStoneSets.GILDED_HOLYSTONE::wall), true, BlockSet.TabAdditionPhase.BEFORE)
            .tabAfter(AetherCreativeTabs.AETHER_NATURAL_BLOCKS, lazySetItem(ReduxStoneSets.GILDED_HOLYSTONE::block), false, BlockSet.TabAdditionPhase.BEFORE)
            .withTag(BlockTags.MINEABLE_WITH_PICKAXE, true);
    ...
    public static final BaseStoneSet SENTRITE = register(new BaseStoneSet("sentrite", MapColor.DEEPSLATE, SoundType.NETHER_ORE, 1.0F, 6.0F, "natural/"))
            ...
            .tabAfter(AetherCreativeTabs.AETHER_BUILDING_BLOCKS, lazySetItem(ReduxStoneSets.BLEAKMOSS_HOLYSTONE::wall), true, BlockSet.TabAdditionPhase.BEFORE)
            .tabAfter(AetherCreativeTabs.AETHER_NATURAL_BLOCKS, lazySetItem(ReduxStoneSets.BLEAKMOSS_HOLYSTONE::block), false, BlockSet.TabAdditionPhase.BEFORE)
            .withTag(BlockTags.MINEABLE_WITH_PICKAXE, true);
    ...
    public static final BaseStoneSet POLISHED_SENTRITE = register(new BaseStoneSet("polished_sentrite", MapColor.DEEPSLATE, SoundType.NETHER_BRICKS, 1.0F, 6.0F, "construction/"))
            ...
            .tabAfter(AetherCreativeTabs.AETHER_BUILDING_BLOCKS, lazySetItem(ReduxStoneSets.SENTRITE::wall), true, BlockSet.TabAdditionPhase.BEFORE)
    ...
    public static final BaseStoneSet SENTRITE_BRICKS = register(new BrickStoneSet("sentrite_brick", MapColor.DEEPSLATE, SoundType.NETHER_BRICKS, 1.0F, 6.0F, "construction/"))
            ...
            .tabAfter(AetherCreativeTabs.AETHER_BUILDING_BLOCKS, lazySetItem(ReduxStoneSets.POLISHED_SENTRITE::wall), true, BlockSet.TabAdditionPhase.BEFORE)
            .withTag(BlockTags.MINEABLE_WITH_PICKAXE, true);
    ...
    public static final BaseStoneSet ANGILITE = register(new BaseStoneSet("angilite", MapColor.TERRACOTTA_YELLOW, SoundType.TUFF, 0.5F, 6.0F, "natural/"))
            ...
            .tabAfter(AetherCreativeTabs.AETHER_BUILDING_BLOCKS, lazySetItem(ReduxStoneSets.SENTRITE::wall), true, BlockSet.TabAdditionPhase.BEFORE)
            .tabAfter(AetherCreativeTabs.AETHER_NATURAL_BLOCKS, lazySetItem(ReduxStoneSets.SENTRITE::block), false, BlockSet.TabAdditionPhase.BEFORE)
            .withTag(BlockTags.MINEABLE_WITH_PICKAXE, true);
