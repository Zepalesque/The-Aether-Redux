...
public class LogWallWoodSet extends BaseWoodSet {
	...
	protected DeferredBlock<ReduxNaturalWall> logWall(
		...
		var block = registry.register(id + this.logSuffix(false, false) + "_wall", () ->
			new ReduxNaturalWall(
				Properties.of()
					.mapColor(color)
	...
	protected DeferredBlock<ReduxNaturalWall> woodWall(
		DeferredRegister.Blocks registry,
		DeferredRegister.Items items,
		String id,
		MapColor color,
		...
		var block = registry.register(id + this.woodSuffix(false, false) + "_wall", () ->
			new ReduxNaturalWall(
				Properties.of()
					.mapColor(color)
					.instrument(NoteBlockInstrument.BASS)
	...
	protected DeferredBlock<ReduxNaturalWall> strippedLogWall(
		DeferredRegister.Blocks registry,
		DeferredRegister.Items items,
		String id,
		MapColor color,
		...
		var block = registry.register("stripped_" + id + this.logSuffix(false, false) + "_wall", () ->
			new ReduxNaturalWall(
				Properties.of()
					.mapColor(color)
					.instrument(NoteBlockInstrument.BASS)
	...
	protected DeferredBlock<ReduxNaturalWall> strippedWoodWall(
		DeferredRegister.Blocks registry,
		DeferredRegister.Items items,
		String id,
		MapColor color,
		...
		var block = registry.register("stripped_" + id + this.woodSuffix(false, false) + "_wall", () ->
			new ReduxNaturalWall(
				Properties.of()
					.mapColor(color)
					.instrument(NoteBlockInstrument.BASS)
	...
	public void blockData(ReduxBlockStateProvider data) {
		...
		ModelFile side = data.makeWallSideModel(
			5,
			14,
			"wooden_side",
		...
		ModelFile sideAlt = data.makeWallSideModel(
			5,
			14,
			"wooden_side_alt",
		...
		ModelFile sideTall = data.makeWallSideModel(
			5,
			16,
			"wooden_side_tall",
			ModelBuilder.FaceRotation.CLOCKWISE_90,
		...
		ModelFile sideTallAlt = data.makeWallSideModel(
			5,
			16,
			"wooden_side_tall_alt",
			ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90,
			11,
			16
		);
		ModelFile sideShort = data.makeWallSideModel(
			4,
			14,
			"wooden_side_short",
			ModelBuilder.FaceRotation.CLOCKWISE_90,
		...
		ModelFile sideAltShort = data.makeWallSideModel(
			4,
			14,
			"wooden_side_alt_short",
			ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90,
			12,
			16
		);
		ModelFile sideTallShort = data.makeWallSideModel(
			4,
			16,
			"wooden_side_tall_short",
			ModelBuilder.FaceRotation.CLOCKWISE_90,
			0,
			4
		);
		ModelFile sideTallAltShort = data.makeWallSideModel(
			4,
			16,
			"wooden_side_tall_alt_short",
			ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90,
			12,
			16
		);
	...
	public void langData(ReduxLanguageProvider data) {
		...
		data.addLore(
			...
			"Crafted from "
				+ name
				+ " "
				+ this.logSuffix(true, false)
				+ ". Can be used for decorative enclosures and defences. Great for keeping nasty intruders away!"
		);

		data.addBlock(this.strippedLogWall());
		data.addLore(
			this.strippedLogWall(),
			"Crafted from Stripped "
				+ name
				+ " "
				+ this.logSuffix(true, false)
				+ ". Can be used for decorative enclosures and defences. Great for keeping nasty intruders away!"
		...
		data.addLore(
			...
			"Crafted from "
				+ name
				+ " "
				+ this.woodSuffix(true, false)
				+ ". Can be used for decorative enclosures and defences. Great for keeping nasty intruders away!"
		);

		data.addBlock(this.strippedWoodWall());
		data.addLore(
			this.strippedWoodWall(),
			"Crafted from Stripped "
				+ name
				+ " "
				+ this.woodSuffix(true, false)
	...
	public void recipeData(
		...
		var conditional = consumer.withConditions(
			new ConditionRecipeModule(lookup.holderOrThrow(ReduxConditions.GENESIS))
		);
