...
public class ReduxWoodSets {
	...
	public static final LogWallWoodSet GLACIA = register(new RegularBookshelfSet("glacia", MapColor.TERRACOTTA_BLACK, MapColor.TERRACOTTA_LIGHT_GRAY, SoundType.WOOD));
