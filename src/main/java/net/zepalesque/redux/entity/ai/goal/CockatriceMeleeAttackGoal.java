...
public class CockatriceMeleeAttackGoal extends Goal {
        ...
        if (i - this.lastCanUseCheck < 20L) {
            ...
            if (livingentity == null) {
                ...
                if (this.path != null) {
                    ...
                    return this.getAttackReachSqr(livingentity) >= this.mob.distanceToSqr(livingentity.getX(), livingentity.getY(), livingentity.getZ()) && !this.isShooting();
                }
            }
        }
    }
    ...
    public boolean canContinueToUse() {
        ...
        if (livingentity == null) {
            ...
            return (!(livingentity instanceof Player) || !livingentity.isSpectator() && !((Player)livingentity).isCreative()) && !this.isShooting();
        }
    }
