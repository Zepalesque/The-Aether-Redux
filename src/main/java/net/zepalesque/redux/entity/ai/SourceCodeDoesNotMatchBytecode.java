...
public class SourceCodeDoesNotMatchBytecode extends Goal {
   ...
   public SourceCodeDoesNotMatchBytecode(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
      this.mob = mob;
