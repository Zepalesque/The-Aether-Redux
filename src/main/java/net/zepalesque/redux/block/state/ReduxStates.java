...
public class ReduxStates {
	...
	public static final IntegerProperty CLOUDCAP_VARIANT = IntegerProperty.create(
		"cloudcap_variant",
		0,
		4
	);

	public static final EnumProperty<LogicatorMode> MODE_LOGICATOR = EnumProperty.create(
		"mode",
		LogicatorMode.class
	);
	public static final EnumProperty<BlightGrassColor> BLIGHT_GRASS_COLOR = EnumProperty.create(
		"color",
		BlightGrassColor.class
	);

	public static final EnumProperty<AetherMossType> AETHER_MOSS_TYPE = EnumProperty.create(
		"type",
		AetherMossType.class
	);
}
