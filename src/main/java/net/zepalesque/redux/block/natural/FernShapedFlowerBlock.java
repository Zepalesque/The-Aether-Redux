...
public class FernShapedFlowerBlock extends FlowerBlock {
    protected static final VoxelShape SHAPE_FERN = Block.box(4.0D, 0.0D, 4.0D, 12.0D, 15.0D, 12.0D);

    public FernShapedFlowerBlock(Supplier<MobEffect> effectSupplier, int pEffectDuration, Properties pProperties) {
